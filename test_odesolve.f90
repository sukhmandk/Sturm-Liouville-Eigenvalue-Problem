...
subroutine ode1(t,y,yp,f,dfdy,dfdyp,userpar)
implicit double precision (a-h,o-z)
...
subroutine ode2(t,y,yp,f,dfdy,dfdyp,userpar)
implicit double precision (a-h,o-z)
...
subroutine ode3(t,y,yp,f,dfdy,dfdyp,userpar)
implicit double precision (a-h,o-z)
...
call ode_solve_ivp_adap(ier,eps,nintsin,abin,k,xscheb,chebintl,ucheb,nints,ab,&
   ys,yders,yder2s,ode2,ya,ypa,userpar)
...
call ode_solve_tvp_adap(ier,eps,nintsin,abin,k,xscheb,chebintr,ucheb,nints,ab,&
   ys,yders,yder2s,ode3,yb,ypb,userpar)
...
call elapsed(t1)
call ode_solve_ivp(ier,nints,ab,k,xscheb,chebintl,ys,yders,yder2s,ode1,userpar)
call elapsed(t2)
...
call ode_solve_tvp(ier,nints,ab,k,xscheb,chebintr,ys,yders,yder2s,ode1,userpar)
if (ier .ne. 0) then
call prini("after ode_solve_ivp, ier = ",ier)
stop
endif
...
call ode_trap_ivp(ier,k,ts,ode1,ys,yders,yder2s,userpar)
...
call ode_trap_tvp(ier,k,ts,ode1,ys,yders,yder2s,userpar)
